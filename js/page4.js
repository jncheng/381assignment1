...
var PageFourContent = React.createClass({
  ...
  render: function() {
    return React.DOM.div({id:'header-div'},null,
      ...
      React.DOM.p(null, React.DOM.button({className: 'answers',id: 'wrong'},null, 'Wrapped together in Tin foil')),
      React.DOM.p(null, React.DOM.button({className: 'answers',id: 'wrong'},null, 'Wrapped together in a plastic bag')),
      React.DOM.p(null, React.DOM.button({className: 'answers',id: 'wrong'},null, 'Individually wrapped in Tin Foil')),

      /* right answer*/
      React.DOM.p({onClick: addScore}, React.DOM.button({className: 'answers',id: 'right'}, null,'Individually wrapped in plastic bags')),
      React.DOM.h3(null, ''),
        //return React.DOM.div(null,
        // return React.DOM.div({id: 'left-col'}, 
        React.DOM.div({id: 'right-col'},null,
          JQueryMobileButton({id: 'nextQ',href:'#five'}, '>')
        ),
